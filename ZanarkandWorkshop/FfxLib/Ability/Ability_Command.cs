...
namespace FFXProjectEditor.FfxLib.Ability
{
    ...
    public class Ability_Command
    {
        ...
        public enum DamageFlags : byte
        {
            ...
            GearCritBonus           = 1 << 3,
            Heals                   = 1 << 4,
            CleansesStatuses        = 1 << 5,
            SupressBreakDamageLimit = 1 << 6,
            BreaksDamageLimit       = 1 << 7,
        }
        ...
        {
            get => BitFlag_Util.IsFlagSet(SpecialBuffFlgs, SpecialBuffFlags.dmg_9999);
            set => SpecialBuffFlgs = BitFlag_Util.SetFlag(SpecialBuffFlgs, SpecialBuffFlags.dmg_9999, value);
        }
